...
<body class="bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 antialiased transition-colors duration-300 overflow-x-hidden">
    ...
    <div class="loader-wrapper">
        ...
        <img src="{{ asset('img/sgc-logo.png') }}" class="loader-logo" />
    ...
    <nav id="navbar"
        ...
        <div class="flex items-center justify-between px-6 py-4">
            ...
            <a href="#" class="flex items-center gap-3 select-none">
                <img src="{{ asset('img/sgc-logo.png') }}" class="h-10 md:h-12 drop-shadow-sm" />
            </a>
            ...
            <div class="grid md:grid-cols-4 gap-12">
                ...
                <div>
                    <div class="flex items-center gap-3 mb-5">
                        <img src="{{ asset('img/sgc-logo.png') }}" class="h-12 drop-shadow-md" />
