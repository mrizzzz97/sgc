...
<head>
    ...
    <title>Download Sertifikat - {{ $certificate->full_name }}</title>
        ...
        <div class="max-w-2xl w-full">
            ...
            <div class="mb-8 p-6 bg-amber-100 border-l-4 border-amber-600 rounded-lg shadow-md">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-amber-700">Sertifikat Anda untuk modul <strong>{{ $module->title }}</strong> siap dilihat dan dicetak.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white shadow-xl rounded-lg overflow-hidden mb-8">
                ...
                <div class="text-center p-6">
                    ...
                    <p class="text-2xl font-bold text-amber-700 mb-4 font-playfair">{{ $module->title }}</p>
                    <p class="text-sm text-gray-600">Nomor Sertifikat: <span class="font-mono font-bold">{{ $certificate->certificate_number }}</span></p>
                    <p class="text-sm text-gray-600">Diselesaikan pada: {{ $certificate->completed_at->format('d F Y') }}</p>
                </div>
            </div>
            ...
            <div class="flex flex-col sm:flex-row gap-4">
                ...
                <a href="{{ route('certificates.show', $certificate) }}" class="flex-1 bg-amber-600 hover:bg-amber-700 text-white font-bold py-3 px-6 rounded-lg transition duration-200 flex items-center justify-center gap-2 shadow-lg">
                ...
                <a href="{{ route('modules.show', $module) }}" class="flex-1 bg-gray-600 hover:bg-gray-700 text-white font-bold py-3 px-6 rounded-lg transition duration-200 text-center flex items-center justify-center gap-2">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
