...
<div class="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-indigo-900 transition-colors duration-300">
    <div class="max-w-3xl mx-auto p-4 sm:p-6 lg:p-8">
            ...
            <div class="bg-gradient-to-r from-indigo-500 to-purple-600 p-6">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-indigo-100 mt-1">Halaman {{ $page->page_number }} — {{ ucfirst($page->type) }}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden transform transition-all duration-500 hover:shadow-2xl">
            <form action="{{ route('guru.modul.chapter.pages.update', [$chapter->id, $page->id]) }}" method="POST" class="p-6 md:p-8">
                @csrf
                @method('PATCH')
                ...
                <div class="mb-6 group">
                    ...
                    <div class="relative">
                        ...
                        <select name="type" id="pageType"
                            ...
                            <option value="video" {{ $page->type === 'video' ? 'selected' : '' }}>Video</option>
                            <option value="question" {{ $page->type === 'question' ? 'selected' : '' }}>Soal</option>
                        </select>
                ...
                <!-- Video Form -->
                <div id="videoForm" class="{{ $page->type === 'video' ? '' : 'hidden' }} mb-6 transform transition-all duration-500 {{ $page->type === 'video' ? 'opacity-100' : 'opacity-0' }} {{ $page->type === 'video' ? 'max-h-96' : 'max-h-0' }} overflow-hidden">
                ...
                <!-- Question Form -->
                <div id="questionForm" class="{{ $page->type === 'question' ? '' : 'hidden' }} transform transition-all duration-500 {{ $page->type === 'question' ? 'opacity-100' : 'opacity-0' }} {{ $page->type === 'question' ? 'max-h-screen' : 'max-h-0' }} overflow-hidden">
                    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 p-4 rounded-lg border border-blue-200 dark:border-blue-800">
                        ...
                        <div class="mb-4 group">
                            ...
                            <textarea id="question_text"
                                      ...
                                      rows="3">{{ $page->question_text }}</textarea>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                ...
                                <div class="relative group">
                                    ...
                                    <input type="text" name="options[a]" value="{{ $opts['a'] ?? '' }}"
                                ...
                                <div class="relative group">
                                    ...
                                    <input type="text" name="options[b]" value="{{ $opts['b'] ?? '' }}"
                                           class="w-full pl-8 pr-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 transform focus:scale-[1.02]"
                                           placeholder="Opsi B">
                                </div>
                                <div class="relative group">
                                    ...
                                    <input type="text" name="options[c]" value="{{ $opts['c'] ?? '' }}"
                                           class="w-full pl-8 pr-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 transform focus:scale-[1.02]"
                                           placeholder="Opsi C">
                                </div>
                                <div class="relative group">
                                    ...
                                    <input type="text" name="options[d]" value="{{ $opts['d'] ?? '' }}"
                                           class="w-full pl-8 pr-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 transform focus:scale-[1.02]"
                                           placeholder="Opsi D">
                                </div>
                            </div>
                        ...
                        <div class="group">
                            ...
                            <div class="relative">
                                ...
                                <select name="correct_answer"
                                    ...
                                    <option value="a" {{ $page->correct_answer === 'a' ? 'selected' : '' }}>A</option>
                                    <option value="b" {{ $page->correct_answer === 'b' ? 'selected' : '' }}>B</option>
                                    <option value="c" {{ $page->correct_answer === 'c' ? 'selected' : '' }}>C</option>
                                    <option value="d" {{ $page->correct_answer === 'd' ? 'selected' : '' }}>D</option>
                                </select>
                                <div class="absolute inset-y-0 right-0 flex items-center px-2 pointer-events-none">
                                    <svg class="fill-current h-4 w-4 text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                        <path d="M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757 6.586 4.343 8z" />
