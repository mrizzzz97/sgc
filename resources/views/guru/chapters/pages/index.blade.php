                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-indigo-100 text-sm sm:text-base">{{ $chapter->title }}</p>
                        </div>
                    </div>
                        ...
                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                            ...
                            <div class="flex items-start sm:items-center gap-4 flex-1">
                                ...
                                <div class="flex-shrink-0 bg-gradient-to-br 
                                    {{ $p->type === 'video' ? 'from-red-400 to-pink-500' : 'from-blue-400 to-indigo-500' }}
                                ...
                                <div class="min-w-0">
                                    ...
                                    <div class="flex flex-wrap items-center gap-2 mt-1 text-xs">
                                        ...
                                        @elseif($p->type === 'question')
                                            <span class="text-gray-500 dark:text-gray-400 truncate 
                                                         max-w-[150px] sm:max-w-xs">
                                                {{ Str::limit($p->question_text, 50) }}
                                            </span>
                                        @endif
