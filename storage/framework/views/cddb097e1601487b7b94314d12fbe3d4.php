...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex items-center justify-between animate-fade-in-up" style="animation-delay: 0.4s;">
                        ...
                        <div class="text-sm">
                            <a href="<?php echo e(route('password.request')); ?>" class="font-medium text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 dark:hover:text-indigo-300 transition duration-200">Lupa password?</a>
                        </div>
                    </div>
                ...
                <div class="mt-8 border-t border-gray-200 dark:border-gray-600 pt-6 animate-fade-in-up" style="animation-delay: 0.6s;">
                    <div class="text-center">
                        <p class="text-sm text-gray-600 dark:text-gray-400">
                            Belum punya akun?
                            <a href="<?php echo e(route('register')); ?>" class="font-medium text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 dark:hover:text-indigo-300 transition duration-200">
...
</html><?php /**PATH C:\school\idn-kelas-10\lomba-lomba\te\laravel\sgc\resources\views/auth/login.blade.php ENDPATH**/ ?>