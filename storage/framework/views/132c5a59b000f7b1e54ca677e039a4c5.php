...
<div class="max-w-4xl mx-auto p-4 md:p-6 animate-fade-in">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <a href="<?php echo e(route('guru.profile.edit')); ?>" class="flex items-center gap-3 p-4 bg-green-50 dark:bg-green-900/20 hover:bg-green-100 dark:hover:bg-green-900/30 rounded-lg transition-colors duration-200">
