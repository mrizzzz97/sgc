        ...
        <div class="bg-white overflow-hidden shadow-lg sm:rounded-lg">
            ...
            <div class="bg-gradient-to-r from-blue-500 to-indigo-600 px-6 py-8 sm:px-10 sm:py-10">
                <div class="flex items-center justify-between">
                    ...
                    <a href="<?php echo e(route('guru.index')); ?>" class="text-white hover:text-blue-200 flex items-center transition-colors duration-200">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\school\idn-kelas-10\lomba-lomba\te\laravel\sgc\resources\views\modules\create.blade.php ENDPATH**/ ?>