    ...
    <div class="flex min-h-screen">
        ...
        <aside class="hidden lg:flex flex-col w-72 bg-white dark:bg-gray-800 border-r dark:border-gray-700
            ...
            <div class="flex items-center gap-3 mb-8 transform hover:scale-[1.02] transition">
                <img src="<?php echo e(asset('img/sgc-logo.png')); ?>" class="w-10 h-10 rounded-xl shadow">
                <div>
            ...
            <nav class="space-y-2">
                ...
                <?php echo $__env->yieldContent('leaderboard_button'); ?>
                ...
                <a href="<?php echo e(route('murid.leaderboard')); ?>"
                class="nav-item flex items-center gap-3 px-4 py-3 rounded-xl
                        <?php echo e(request()->routeIs('murid.leaderboard') ? 'nav-active' : ''); ?>">
...
<?php /**PATH C:\school\idn-kelas-10\lomba-lomba\te\laravel\sgc\resources\views/layouts/dashboard.blade.php ENDPATH**/ ?>