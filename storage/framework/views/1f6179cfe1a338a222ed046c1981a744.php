...
<div class="max-w-4xl mx-auto p-4 md:p-6 animate-fade-in">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 overflow-hidden group">
            ...
            <div class="p-6">
                ...
                <p class="text-3xl font-bold text-blue-600 dark:text-blue-400">
                    <?php echo e(DB::table('modules')->count()); ?>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 overflow-hidden group">
            ...
            <div class="p-6">
                ...
                <p class="text-3xl font-bold text-purple-600 dark:text-purple-400">
                    <?php echo e(DB::table('chapters')->count()); ?>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <a href="<?php echo e(route('guru.modul.create')); ?>" class="flex items-center gap-3 p-4 bg-indigo-50 dark:bg-indigo-900/20 hover:bg-indigo-100 dark:hover:bg-indigo-900/30 rounded-lg transition-colors duration-200">
            ...
            <a href="<?php echo e(route('guru.modul.index')); ?>" class="flex items-center gap-3 p-4 bg-purple-50 dark:bg-purple-900/20 hover:bg-purple-100 dark:hover:bg-purple-900/30 rounded-lg transition-colors duration-200">
            ...
            <a href="<?php echo e(route('guru.profile')); ?>" class="flex items-center gap-3 p-4 bg-green-50 dark:bg-green-900/20 hover:bg-green-100 dark:hover:bg-green-900/30 rounded-lg transition-colors duration-200">
...
<?php echo $__env->make('layouts.guru', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\school\IDN kls 10\lomba-lomba\te\laravel\sgc\resources\views/dashboard/guru.blade.php ENDPATH**/ ?>