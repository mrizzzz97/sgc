    ...
    <div class="flex min-h-screen">
        ...
        <aside class="hidden lg:flex w-72 flex-col sidebar-bg dark:bg-gray-800 p-6 border-r dark:border-gray-700 card-shadow dark:card-shadow-dark sidebar-enter">
            ...
            <nav class="space-y-2">
                ...
                <a href="<?php echo e(route('guru.profile')); ?>"
                    class="nav-item flex items-center gap-3 px-4 py-3 rounded-xl hover-lift
                    text-gray-700 dark:text-gray-300
                    <?php echo e(request()->routeIs('guru.profile') ? 'active-nav text-indigo-600 font-semibold' : ''); ?>">
...
</html><?php /**PATH C:\school\IDN kls 10\lomba-lomba\te\laravel\sgc\resources\views/layouts/guru.blade.php ENDPATH**/ ?>