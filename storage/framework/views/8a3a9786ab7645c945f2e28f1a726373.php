...
<div class="max-w-3xl mx-auto mt-10">
    ...
    <?php if(session('success')): ?>
        <div class="mb-4 p-4 rounded-lg text-green-800 bg-green-100 dark:bg-green-900 dark:text-green-200">
    ...
    <?php if($errors->any()): ?>
        <div class="mb-4 p-4 rounded-lg text-red-800 bg-red-100 dark:bg-red-900 dark:text-red-200">
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\school\idn-kelas-10\lomba-lomba\te\laravel\sgc\resources\views/profile/edit.blade.php ENDPATH**/ ?>