...
<body class="bg-gray-100">
    ...
    <div class="no-print flex justify-center gap-4 p-4 bg-white sticky top-0 shadow-md">
        ...
        <a href="<?php echo e(route('modules.index')); ?>" class="bg-gray-600 text-white px-6 py-2 rounded hover:bg-gray-700 transition-colors">
            ← Kembali
        </a>
    </div>
        ...
        <div class="max-w-4xl w-full bg-white shadow-2xl relative overflow-hidden" style="aspect-ratio: 16/10;">
            ...
            <div class="absolute inset-0 flex flex-col items-center justify-center p-8 md:p-12 text-center">
                ...
                <div class="absolute top-8 right-8 w-24 h-24 opacity-20">
                    <!-- Ganti dengan <img src="<?php echo e(asset('images/logo-sgc.png')); ?>" alt="Logo SGC-EasyLearn"> -->
                ...
                <div class="mb-12 text-gray-700 max-w-2xl">
                    ...
                    <p class="text-2xl font-bold text-amber-700 mb-4 font-playfair"><?php echo e($certificate->module->title); ?></p>
...
</html><?php /**PATH C:\school\idn-kelas-10\lomba-lomba\te\laravel\sgc\resources\views\certificates\pdf.blade.php ENDPATH**/ ?>