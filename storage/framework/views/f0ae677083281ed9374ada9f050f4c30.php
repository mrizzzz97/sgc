...
<div class="max-w-4xl mx-auto py-10">
    ...
    <?php if($errors->any()): ?>
        <div class="mb-6 p-4 bg-red-50 dark:bg-red-900/40 border border-red-500 dark:border-red-600 text-red-700 dark:text-red-300 rounded">
            <p class="font-semibold mb-2">Ada <?php echo e(count($errors)); ?> kesalahan:</p>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-8 transition">
        ...
        <form action="<?php echo e(route('admin.guru.store')); ?>" method="POST" class="space-y-6">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\school\idn-kelas-10\lomba-lomba\te\laravel\sgc\resources\views/admin/guru/create.blade.php ENDPATH**/ ?>