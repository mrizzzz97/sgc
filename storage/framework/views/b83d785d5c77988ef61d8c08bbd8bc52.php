...
<div class="wrapper">
    ...
    <!-- Watermark -->
    <img src="<?php echo e(public_path('img/sgc-logo.png')); ?>" class="watermark">

    <!-- Logo -->
    <img src="<?php echo e(public_path('img/sgc-logo.png')); ?>" class="logo">
    ...
    <div class="seal">
        <div class="seal-circle">
            <div class="seal-inner">
                <div class="seal-score"><?php echo e($score); ?>%</div>
    ...
    <div class="footer">
        ...
        <div class="signature-box">
            <img src="<?php echo e(public_path('img/ttd.png')); ?>" class="signature-image">
