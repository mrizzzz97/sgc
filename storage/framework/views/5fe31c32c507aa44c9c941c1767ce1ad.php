...
<?php $__env->startSection('title', 'Tambah Halaman'); ?>
...
<div class="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-indigo-900 transition-colors duration-300">
    <div class="max-w-3xl mx-auto p-4 sm:p-6 lg:p-8">
            ...
            <div class="bg-gradient-to-r from-indigo-500 to-purple-600 p-6">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-indigo-100 mt-1">Chapter: <?php echo e($chapter->title); ?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden transform transition-all duration-500 hover:shadow-2xl">
            <form action="<?php echo e(route('guru.modul.chapter.pages.store', $chapter->id)); ?>" method="POST" class="p-6 md:p-8">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.guru', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\school\idn-kelas-10\lomba-lomba\te\laravel\sgc\resources\views/guru/chapters/pages/create.blade.php ENDPATH**/ ?>