            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <?php $__currentLoopData = $materi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="group p-8 bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100">
                        ...
                        <h3 class="text-xl font-semibold text-gray-900 mb-2 group-hover:text-primary transition-colors"><?php echo e($m[0]); ?></h3>
                        <p class="text-gray-600 text-sm"><?php echo e($m[1]); ?></p>
                        <div class="mt-4 w-full bg-gray-200 rounded-full h-2">
                            <div class="bg-primary h-2 rounded-full" style="width: <?php echo e(rand(60, 100)); ?>%"></div>
                        </div>
                    </div>
                ...
                <?php $__currentLoopData = $project; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="group overflow-hidden rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                        ...
                        <div class="p-6 bg-white">
                            <h3 class="text-xl font-semibold text-gray-900 mb-2 group-hover:text-primary transition-colors"><?php echo e($p[0]); ?></h3>
                            <p class="text-gray-600 text-sm mb-4"><?php echo e($p[1]); ?></p>
    ...
    <section id="kelas" class="py-24 bg-gray-50">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid md:grid-cols-3 gap-10">
                ...
                <?php $__currentLoopData = $kelas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="p-8">
                            <div class="flex items-center justify-between mb-4">
                                <span class="px-3 py-1 text-xs font-medium rounded-full 
                                    <?php if($c[2] === 'beginner'): ?> bg-green-100 text-green-800
                                    <?php elseif($c[2] === 'intermediate'): ?> bg-yellow-100 text-yellow-800
                                    <?php elseif($c[2] === 'advanced'): ?> bg-red-100 text-red-800
                            ...
                            <h3 class="text-xl font-bold text-gray-900 mb-2 group-hover:text-primary transition-colors"><?php echo e($c[0]); ?></h3>
                            <p class="text-gray-600 mb-6"><?php echo e($c[1]); ?></p>
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    ...
                                    <span class="ml-2 text-sm text-gray-500"><?php echo e(rand(50, 200)); ?>+ siswa</span>
                                </div>
...
</body><?php /**PATH C:\school\IDN kls 10\lomba-lomba\te\laravel\sgc\resources\views/landing.blade.php ENDPATH**/ ?>