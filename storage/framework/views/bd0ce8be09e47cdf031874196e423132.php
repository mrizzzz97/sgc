            ...
            <div class="bg-white overflow-hidden shadow-xl rounded-xl">
                <div class="p-6 bg-white">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <a href="<?php echo e(route('guru.index')); ?>" class="text-indigo-600 hover:text-indigo-800 flex items-center transition-colors duration-200">
                    ...
                    <?php if($errors->any()): ?>
                        <div class="mb-6 p-4 bg-red-50 border-l-4 border-red-500 text-red-700 rounded">
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    <h3 class="text-sm font-medium text-red-800">Ada <?php echo e(count($errors->all())); ?> kesalahan pada form</h3>
                    ...
                    <form action="<?php echo e(route('guru.store')); ?>" method="POST" class="space-y-6">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="flex items-center justify-between pt-6 border-t border-gray-200">
                            ...
                            <div class="flex items-center space-x-3">
                                <a href="<?php echo e(route('guru.index')); ?>" class="px-4 py-2 bg-gray-200 text-gray-700 rounded-md hover:bg-gray-300 transition-colors duration-200 flex items-center">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\school\IDN kls 10\lomba-lomba\te\laravel\sgc\resources\views/admin/guru/create.blade.php ENDPATH**/ ?>